...
public enum CustomOAuth2Provider {
	...
	protected final ClientRegistration.Builder getBuilder(String registraionId, 
			ClientAuthenticationMethod method, String redirectUri) {
		ClientRegistration.Builder builder = ClientRegistration.withRegistrationId(registraionId);
